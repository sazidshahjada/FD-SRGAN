...
class TruncatedVGG19(nn.Module):
    ...
    def __init__(self, i, j):
        """
        Args:
            i: the maxpooling layer before which to truncate (must be between 1 and 5, inclusive)
            j: the convolutional layer after which to truncate, before the above maxpooling layer (must be between 1 and 4, inclusive)
        """
